namespace KyberNET.Testing.Unit.Constants
{
    ...
    public class KyberParameterTest
    {
            ...
            : KyberParameterTest
        {
            ...
            {
                Assert.ThrowsException<UnsupportedKyberVariantException>(() => KyberParameter.FindByCipherTextSize(999));
            }
        }
            ...
            : KyberParameterTest
        {
            ...
            public void ThrowsForInvalidLength()
            {
                Assert.ThrowsException<UnsupportedKyberVariantException>(() => KyberParameter.FindByEncryptionKeySize(999));
            }
        }
            ...
            : KyberParameterTest
        {
            ...
            public void ThrowsForInvalidLength()
            {
                Assert.ThrowsException<UnsupportedKyberVariantException>(() => KyberParameter.FindByEncapsulationKeySize(999));
            }
        }
            ...
            : KyberParameterTest
        {
            ...
            public void ThrowsForInvalidLength()
            {
                Assert.ThrowsException<UnsupportedKyberVariantException>(() => KyberParameter.FindByDecryptionKeySize(999));
            }
        }
            ...
            : KyberParameterTest
        {
            ...
            public void ThrowsForInvalidLength()
            {
                Assert.ThrowsException<UnsupportedKyberVariantException>(() => KyberParameter.FindByDecapsulationKeySize(999));
            }
        }
    }
}